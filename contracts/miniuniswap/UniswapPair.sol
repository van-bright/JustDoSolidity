...
contract UniswapPair is IUniswapPair {
    ...
    string public constant name = 'Uniswap Token';
    string public constant symbol = 'UNI-T';
    ...
    function _update(uint balance0, uint balance1, uint112 _reserve0, uint112 _reserve1) private {
        require(balance0 <= type(uint112).max && balance1 <= type(uint112).max, 'UniswapPair: OVERFLOW');
